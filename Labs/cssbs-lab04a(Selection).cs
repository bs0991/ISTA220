...
namespace Selection
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        // Declaring method dateCompare with a return type of 'int'. dateCompare has two input parameters: leftHandSide and rightHandSide
        // of type DateTime.
        private int dateCompare(DateTime leftHandSide, DateTime rightHandSide)
        {
            // Declaring a variable named result of type int and initilizing it to the value of '0'
            int result = 0;
            
            //Checks if the lefHandSide's (obejct) Year (property) is less than the rightHandSide.Year
